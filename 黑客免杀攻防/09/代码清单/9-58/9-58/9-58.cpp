...
{
public:
	CGirl():m_Girl_1(0x55555555),m_Girl_2(0x6666)
	{
...
class CBaby:public CBoy,CGirl
{
public:
	CBaby():m_CBaby_1(0x88888888),m_CBaby_2(0x9999)
	{
		printf("CBaby() Constructor...\r\n");
	}
	~CBaby()
	{
		printf("CBaby() Destructor...\r\n");
	}
	void Show(int nID)
	{
		printf("ID:%d CBaby!\r\n\r\n",nID);
	...
	void LoveYou()
	{
		printf("Yi~Ha! I love you daddy! ^_^\r\n");
	}
	void KissYou()
	{
		printf("Kiss me,Mom...\r\n\r\n");
